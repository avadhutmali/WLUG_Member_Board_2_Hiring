...
export function HeroSection() {
  ...
  const logoOpacity = useTransform(scrollYProgress, [0, 1], [2, 0]);

  return (
    <>
      <motion.a
        href="https://www.wcewlug.org/"
        className="fixed right-5 top-3 z-[100]"
      ...
      <motion.section
        ...
        className={
          "h-[900px] md:h-[800px] md:mt-0 flex items-center overflow-hidden relative [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]"
        }
        style={{
      ...
      >
        ...
        <div
          className={
            "absolute size-64 md:size-96 bg-purple-500 rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[radial-gradient(50%_50%_at_16.8%_18.3%,white,rgb(184,148,255)_50%,rgb(24,0,66))] shadow-[-20px_-20px_50px_rgb(255,255,255,0.5),-20px_-20px_80px_rgb(255,255,255,0.1),0_0_50px_rgb(140,69,255)]"
          }
        />
        ...
        <div className={"container relative mt-16"}>
          <h1
            className={
              "text-[5.5vh] md:text-[100px] md:leading-none font-semibold bg-white tracking-tighter bg-[radial-gradient(100%_100%_at_top_left,rgb(74,32,138,0.9),white,white)] bg-clip-text text-transparent text-center -mt-5"
            }
          ...
          <p
            className={
              "text-lg md:text-xl max-w-xl mx-auto text-white/70 mt-10 md:mt-5 text-center"
            }
          >
